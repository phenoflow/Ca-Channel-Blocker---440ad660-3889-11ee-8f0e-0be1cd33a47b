...
(async () => {
  ...
  await fs.writeFile("ca-channel-blocker-potential-cases.csv", "patient-id,dob,codes,last-encounter\n");
  for(let patient in patients) {
    try {
      ...
      await fs.appendFile("ca-channel-blocker-potential-cases.csv", row);
    } catch(error) {
      console.log(error);
    }
  }
