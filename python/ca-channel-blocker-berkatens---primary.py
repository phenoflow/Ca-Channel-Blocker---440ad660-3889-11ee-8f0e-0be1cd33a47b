...
codes = [{"code":"23872","system":"gprdproduct"},{"code":"25059","system":"gprdproduct"},{"code":"26252","system":"gprdproduct"},{"code":"26265","system":"gprdproduct"},{"code":"28844","system":"gprdproduct"}];
REQUIRED_CODES = 1;
